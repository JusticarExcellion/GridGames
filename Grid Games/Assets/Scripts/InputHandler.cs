...
public class InputHandler : MonoBehaviour
{
    ...
    GetInput_Keyboard( out GameInputStates gameInput ) // TODO: This may need to be looked at and tweaked
    {
        ...
        //NOTE: Gamepad buttons
        gameInput.buttonStates.north.buttonPressed = Input.GetKey( KeyCode.Z );
        gameInput.buttonStates.south.buttonPressed = Input.GetKey( KeyCode.Space );
        gameInput.buttonStates.west.buttonPressed = Input.GetKey( KeyCode.Q );
        gameInput.buttonStates.east.buttonPressed = Input.GetKey( KeyCode.E );
